        ...
        <Main>
            <Seccion>
                <Article>
                    ...
                    y trabajo en equipo, como tambien poder sobrellevar los desafios de forma autonoma.`} height={'7rem'}/>
                </Article>
            ...
            <Seccion>
                <Article>
                    ...
                    <WritingText text={`El amor por la tecnologia, la electronica y la programacion me a llevado a trabajar en diversos sectores del area tecnica 
                    ...
                    de educacion en robotica, electronica y programacion basandome en placas arduino.`} height={'15rem'}/>
                </Article>
                <ImgSwiper imgs='["src/assets/image/905857.jpg","src/assets/image/867357.jpg"]'></ImgSwiper>
            </Seccion>
            <Seccion>
                <Article>
                    ...
                    <WritingText text={`Cuento con multiples pasa tiempos, como la creacion y programacion de placas de desarrollo en Arduino, la impesion en 3D, 
                    la lectura, la musica, hacer ejercicio, reparar todo tipo de aparatos tanto mecanicos como electricos y salir a pasear en moto.`} height={'10rem'}/>
                    <ImgSwiper imgs='["src/assets/image/905857.jpg","src/assets/image/867357.jpg"]'></ImgSwiper>
                </Article>
            </Seccion>
        </Main>
