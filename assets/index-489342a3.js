...
`,Ff=t=>{const{imgs:e}=t;return N.jsx(p2,{spaceBetween:30,effect:"fade",navigation:!0,pagination:{clickable:!0},modules:[h2,l2,c2],className:"mySwiper",children:e.map((n,i)=>N.jsx(m2,{img:n},i))})};Ff.propTypes={imgs:lr.arrayOf(lr.string).isRequired};const g2=ve.main`
    display: flex;
...
`,R2=ve.img`
    ...
    background-position: center;
    background-size: cover;
`,P2=()=>{const t=["src/assets/image/iconTechnologies/swiper-logo.svg","src/assets/image/iconTechnologies/css.svg","src/assets/image/iconTechnologies/git.svg","src/assets/image/iconTechnologies/github.svg","src/assets/image/iconTechnologies/html.svg","src/assets/image/iconTechnologies/java.svg","src/assets/image/iconTechnologies/jira.svg","src/assets/image/iconTechnologies/js.svg","src/assets/image/iconTechnologies/postgre.svg","src/assets/image/iconTechnologies/postman.svg","src/assets/image/iconTechnologies/react.svg","src/assets/image/iconTechnologies/spring.svg","src/assets/image/iconTechnologies/sql.svg","src/assets/image/iconTechnologies/styled.svg","src/assets/image/iconTechnologies/trello.svg","src/assets/image/iconTechnologies/vue.svg","src/assets/image/iconTechnologies/bootstrap.svg"];return N.jsx(b2,{children:N.jsx(A2,{children:t.map((e,n)=>{const i=360/t.length*n;return N.jsx(C2,{style:{transform:"rotateY("+i+"deg)  translateZ(25rem)"},children:N.jsx(R2,{src:e},n)},n)})})})},L2=ve.main`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    padding-right: 2rem;
...
`,Kx=()=>N.jsxs(O2,{children:[N.jsxs(gd,{children:[N.jsx(md,{img:"src/assets/image/redes/linkedin.svg"}),N.jsx(vd,{href:"https://www.linkedin.com/in/mauricio-mores-b3898817b/",children:"Linkedin: Mauricio Mores"})]}),N.jsxs(gd,{children:[N.jsx(md,{img:"src/assets/image/redes/github.svg"}),N.jsx(vd,{href:"https://github.com/MauMor13",children:"Git Hub: Mauricio Mores"})]}),N.jsxs(gd,{children:[N.jsx(md,{img:"src/assets/image/redes/gmail.svg"}),N.jsx(vd,{href:"mailto:mauri.f.mores@gmail.com",children:"Gmail: mauri.f.mores@gmail.com"})]})]}),F2=ve.a`
    text-decoration: none;
...
`,Zx=()=>{const[t,e]=ee.useState(!1),n=()=>{e(!0),setTimeout(()=>{e(!1)},3e3)};return N.jsx(F2,{onClick:n,isActive:t,href:"src/assets/cv/Mauricio_Mores_Dev_Full_Stack_JAVA.pdf",download:"Mauricio_Mores_Dev_Full_Stack_JAVA",children:"Download CV"})},k2=ve.main`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    padding-right: 2rem;
...
`,Y2=()=>{const[t,e]=ee.useState({name:"",email:"",_subject:"",menssage:""}),[n,i]=ee.useState(""),r=o=>{const{name:a,value:l}=o.target;e({...t,[a]:l})},s=async()=>{try{(await fetch("https://formsubmit.co/e7cff579b0fcb4d8b52d651ce2538169",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).ok?i("Formulario enviado con éxito."):i("Hubo un error al enviar el formulario. Por favor, inténtalo de nuevo más tarde.")}catch(o){console.error("Error al enviar el formulario:",o),i("Hubo un error al enviar el formulario. Por favor, inténtalo de nuevo más tarde.")}};return N.jsxs(k2,{children:[N.jsxs(B2,{children:[N.jsx(H2,{children:"You can contact me . . ."}),N.jsx(z2,{children:"Thank you for visiting my portfolio! If you have any feedback on it or simply want to get in touch, your message is most welcome! Rest assured, you´ll receive a prompt response from me. Your opinions and comments are highly valuable, as they help me grow and improve my work. I look forward to hearing from you soon!"})]}),N.jsxs(G2,{children:[N.jsxs(V2,{children:[N.jsx("input",{type:"hidden",name:"_captcha",value:"false"}),N.jsxs(wl,{children:[" Your Full Name :",N.jsx(_d,{type:"text",name:"name",placeholder:"Full Name",required:!0,onChange:r})]}),N.jsxs(wl,{children:["Your Email Contact :",N.jsx(_d,{type:"email",name:"email",placeholder:"Your Email",autoComplete:"off",required:!0,onChange:r})]}),N.jsxs(wl,{children:["Email subject:",N.jsx(_d,{type:"text",name:"_subject",placeholder:"Subject",autoComplete:"off",required:!0,onChange:r})]}),N.jsxs(wl,{children:["Your Menssage :",N.jsx(W2,{name:"menssage",placeholder:"Your Message",rows:"4",required:!0,onChange:r})]}),N.jsx(j2,{onClick:s,children:"Send Message"})]}),N.jsxs($2,{children:[N.jsx(X2,{children:"Networks :"}),N.jsx(Kx,{}),N.jsx(Zx,{})]})]})]})},q2=()=>N.jsx("main",{}),K2=ve.button`
    ...
    `,Vn=t=>N.jsx(K2,{children:t.text});Vn.propTypes={text:lr.string.isRequired};const Z2=ve.nav`
...
`,Qx=t=>{const e=()=>{t.closeNavBar()};return N.jsxs(Z2,{children:[N.jsxs(Q2,{onClick:e,children:[N.jsx("span",{}),N.jsx("span",{})]}),N.jsx(ei,{to:"/",onClick:e,children:N.jsx(Vn,{text:"Home"})}),N.jsx(ei,{to:"/About",onClick:e,children:N.jsx(Vn,{text:"About me"})}),N.jsx(ei,{to:"/Technologies",onClick:e,children:N.jsx(Vn,{text:"Technologies"})}),N.jsx(ei,{to:"/Projects",onClick:e,children:N.jsx(Vn,{text:"Projects"})}),N.jsx(ei,{to:"/Contact",onClick:e,children:N.jsx(Vn,{text:"Contact"})})]})};Qx.propTypes={closeNavBar:lr.func.isRequired};const Jx="https://maumor13.github.io/mauriciomores/assets/svg_20230707_232204_0000-7c118957.svg",J2=ve.header`
    display: flex;
    justify-content: space-between;
    align-items: center;
    width: 100%;
...
`,iI=()=>{const[t,e]=ee.useState(window.innerWidth),[n,i]=ee.useState(!1);ee.useEffect(()=>{const s=()=>{e(window.innerWidth)};return window.addEventListener("resize",s),()=>{window.removeEventListener("resize",s)}},[]);const r=()=>{i(!n)};return N.jsxs(J2,{children:[N.jsx(tI,{}),t<700?N.jsxs(nI,{onClick:r,children:[N.jsx("span",{}),N.jsx("span",{}),N.jsx("span",{})]}):N.jsxs(eI,{children:[N.jsx(ei,{to:"/",children:N.jsx(Vn,{text:"Home"})}),N.jsx(ei,{to:"/About",children:N.jsx(Vn,{text:"About me"})}),N.jsx(ei,{to:"/Technologies",children:N.jsx(Vn,{text:"Technologies"})}),N.jsx(ei,{to:"/Projects",children:N.jsx(Vn,{text:"Projects"})}),N.jsx(ei,{to:"/Contact",children:N.jsx(Vn,{text:"Contact"})})]}),n&&t<700&&N.jsx(Qx,{closeNavBar:r}),N.jsx(EM,{})]})},rI=ve.div`
    position: fixed;
    display: flex;
    justify-content: center;
    align-items: center;
...
`,aI=ve.h1`
    font-family: 'Blouse','Aesthetic','Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
`,ey=t=>N.jsx(rI,{children:N.jsxs(sI,{children:[N.jsxs(oI,{onClick:t.closeModal,children:[N.jsx("span",{}),N.jsx("span",{})]}),N.jsx(aI,{children:"Contact Me"}),N.jsx(Kx,{}),N.jsx(Zx,{})]})});ey.propTypes={closeModal:lr.func.isRequired,modalFooterVisible:lr.bool.isRequired};const lI=ve.footer`
    cursor: default;
    padding-bottom: .5rem;
    display: flex;
    justify-content: center;
...
`,dI=()=>{const[t,e]=ee.useState(!1),n=()=>{e(!t)};return N.jsxs(lI,{children:[t&&N.jsx(ey,{closeModal:n,modalFooterVisible:t}),N.jsxs(cI,{onClick:n,children:[" Full Stack Java Developer ","= ( ) =>","{",N.jsx(uI,{children:"  Mauricio Mores "}),"}"]})]})},fI=ve.div` 
    width: 100vw;
    height: 100vh;
    display: flex;
    justify-content: center;
...
`,pI=()=>N.jsx(fI,{children:N.jsx(hI,{})}),mI=()=>{const[t,e]=ee.useState(!0);return ee.useEffect(()=>{setTimeout(()=>{e(!1)},2e3)},[]),t?N.jsx(pI,{}):N.jsx(Nw,{shouldForwardProp:OM,children:N.jsx(PM,{children:N.jsxs("div",{className:"container_body",children:[N.jsx(iI,{}),N.jsxs(wM,{children:[N.jsx(Er,{path:"/",element:N.jsx(DP,{})}),N.jsx(Er,{path:"About",element:N.jsx(x2,{})}),N.jsx(Er,{path:"Projects",element:N.jsx(T2,{})}),N.jsx(Er,{path:"Technologies",element:N.jsx(N2,{})}),N.jsx(Er,{path:"Contact",element:N.jsx(Y2,{})}),N.jsx(Er,{path:"*",element:N.jsx(q2,{})})]}),N.jsx(dI,{})]})})})};function gI(){return N.jsx(mI,{})}xd.createRoot(document.getElementById("root")).render(N.jsx(gI,{}));
