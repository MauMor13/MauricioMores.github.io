...
`,dI=()=>N.jsx(cI,{children:N.jsx(uI,{})}),fI=()=>{const[t,e]=ee.useState(!0);return ee.useEffect(()=>{setTimeout(()=>{e(!1)},2e3)},[]),t?N.jsx(dI,{}):N.jsx(Uw,{shouldForwardProp:NM,children:N.jsx(RM,{basename:{}.PUBLIC_URL,children:N.jsxs("div",{className:"container_body",children:[N.jsx(eI,{}),N.jsxs(MM,{children:[N.jsx(Er,{path:"/",element:N.jsx(PP,{})}),N.jsx(Er,{path:"About",element:N.jsx(g2,{})}),N.jsx(Er,{path:"Projects",element:N.jsx(E2,{})}),N.jsx(Er,{path:"Technologies",element:N.jsx(I2,{})}),N.jsx(Er,{path:"Contact",element:N.jsx(j2,{})}),N.jsx(Er,{path:"*",element:N.jsx(X2,{})})]}),N.jsx(lI,{})]})})})};function hI(){return N.jsx(fI,{})}xd.createRoot(document.getElementById("root")).render(N.jsx(hI,{}));
