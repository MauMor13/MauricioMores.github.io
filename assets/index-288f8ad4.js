...
`,Jg=ve.img`
    width: 3rem;
    height: 3rem;
`,LP=()=>{const[t,e]=ee.useState("19rem"),n=()=>{const i=window.innerWidth;i<930&&e("10rem"),i<600&&i>400&&e("14rem"),i<400&&e("18rem")};return ee.useEffect(()=>(n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),N.jsxs(TP,{children:[N.jsxs(CP,{children:[N.jsxs(bP,{children:["HI,",N.jsx("br",{})," I´m ",N.jsx(AP,{children:"Mauricio"}),", ",N.jsx("br",{}),"Full Stack Developer . . ."]}),N.jsx(J_,{text:`In this space, I present a tour of my achievements,
...
`,Ff=t=>{const{imgs:e}=t;return N.jsx(f2,{spaceBetween:30,effect:"fade",navigation:!0,pagination:{clickable:!0},modules:[d2,o2,a2],className:"mySwiper",children:e.map((n,i)=>N.jsx(h2,{img:n},i))})};Ff.propTypes={imgs:lr.arrayOf(lr.string).isRequired};const p2=ve.main`
    display: flex;
...
`,A2=ve.img`
    ...
    background-position: center;
    background-size: cover;
`,C2=()=>{const t=["src/assets/image/iconTechnologies/swiper-logo.svg","src/assets/image/iconTechnologies/css.svg","src/assets/image/iconTechnologies/git.svg","src/assets/image/iconTechnologies/github.svg","src/assets/image/iconTechnologies/html.svg","src/assets/image/iconTechnologies/java.svg","src/assets/image/iconTechnologies/jira.svg","src/assets/image/iconTechnologies/js.svg","src/assets/image/iconTechnologies/postgre.svg","src/assets/image/iconTechnologies/postman.svg","src/assets/image/iconTechnologies/react.svg","src/assets/image/iconTechnologies/spring.svg","src/assets/image/iconTechnologies/sql.svg","src/assets/image/iconTechnologies/styled.svg","src/assets/image/iconTechnologies/trello.svg","src/assets/image/iconTechnologies/vue.svg","src/assets/image/iconTechnologies/bootstrap.svg"];return N.jsx(w2,{children:N.jsx(T2,{children:t.map((e,n)=>{const i=360/t.length*n;return N.jsx(b2,{style:{transform:"rotateY("+i+"deg)  translateZ(25rem)"},children:N.jsx(A2,{src:e},n)},n)})})})},R2=ve.main`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    padding-right: 2rem;
...
`,Kx=()=>N.jsxs(U2,{children:[N.jsxs(gd,{children:[N.jsx(md,{img:"src/assets/image/redes/linkedin.svg"}),N.jsx(vd,{href:"https://www.linkedin.com/in/mauricio-mores-b3898817b/",children:"Linkedin: Mauricio Mores"})]}),N.jsxs(gd,{children:[N.jsx(md,{img:"src/assets/image/redes/github.svg"}),N.jsx(vd,{href:"https://github.com/MauMor13",children:"Git Hub: Mauricio Mores"})]}),N.jsxs(gd,{children:[N.jsx(md,{img:"src/assets/image/redes/gmail.svg"}),N.jsx(vd,{href:"mailto:mauri.f.mores@gmail.com",children:"Gmail: mauri.f.mores@gmail.com"})]})]}),N2=ve.a`
    text-decoration: none;
...
`,Zx=()=>{const[t,e]=ee.useState(!1),n=()=>{e(!0),setTimeout(()=>{e(!1)},3e3)};return N.jsx(N2,{onClick:n,isActive:t,href:"src/assets/cv/Mauricio_Mores_Dev_Full_Stack_JAVA.pdf",download:"Mauricio_Mores_Dev_Full_Stack_JAVA",children:"Download CV"})},O2=ve.main`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    padding-right: 2rem;
...
`,X2=()=>{const[t,e]=ee.useState({name:"",email:"",_subject:"",menssage:""}),[n,i]=ee.useState(""),r=o=>{const{name:a,value:l}=o.target;e({...t,[a]:l})},s=async()=>{try{(await fetch("https://formsubmit.co/e7cff579b0fcb4d8b52d651ce2538169",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).ok?i("Formulario enviado con éxito."):i("Hubo un error al enviar el formulario. Por favor, inténtalo de nuevo más tarde.")}catch(o){console.error("Error al enviar el formulario:",o),i("Hubo un error al enviar el formulario. Por favor, inténtalo de nuevo más tarde.")}};return N.jsxs(O2,{children:[N.jsxs(k2,{children:[N.jsx(z2,{children:"You can contact me . . ."}),N.jsx(F2,{children:"Thank you for visiting my portfolio! If you have any feedback on it or simply want to get in touch, your message is most welcome! Rest assured, you´ll receive a prompt response from me. Your opinions and comments are highly valuable, as they help me grow and improve my work. I look forward to hearing from you soon!"})]}),N.jsxs(B2,{children:[N.jsxs(H2,{children:[N.jsx("input",{type:"hidden",name:"_captcha",value:"false"}),N.jsxs(wl,{children:[" Your Full Name :",N.jsx(_d,{type:"text",name:"name",placeholder:"Full Name",required:!0,onChange:r})]}),N.jsxs(wl,{children:["Your Email Contact :",N.jsx(_d,{type:"email",name:"email",placeholder:"Your Email",autoComplete:"off",required:!0,onChange:r})]}),N.jsxs(wl,{children:["Email subject:",N.jsx(_d,{type:"text",name:"_subject",placeholder:"Subject",autoComplete:"off",required:!0,onChange:r})]}),N.jsxs(wl,{children:["Your Menssage :",N.jsx(G2,{name:"menssage",placeholder:"Your Message",rows:"4",required:!0,onChange:r})]}),N.jsx(V2,{onClick:s,children:"Send Message"})]}),N.jsxs(j2,{children:[N.jsx(W2,{children:"Networks :"}),N.jsx(Kx,{}),N.jsx(Zx,{})]})]})]})},$2=()=>N.jsx("main",{}),Y2=ve.button`
    ...
    `,Vn=t=>N.jsx(Y2,{children:t.text});Vn.propTypes={text:lr.string.isRequired};const q2=ve.nav`
...
`,sI=ve.h1`
    font-family: 'Blouse','Aesthetic','Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
`,ey=t=>N.jsx(nI,{children:N.jsxs(iI,{children:[N.jsxs(rI,{onClick:t.closeModal,children:[N.jsx("span",{}),N.jsx("span",{})]}),N.jsx(sI,{children:"Contact Me"}),N.jsx(Kx,{}),N.jsx(Zx,{})]})});ey.propTypes={closeModal:lr.func.isRequired,modalFooterVisible:lr.bool.isRequired};const oI=ve.footer`
    cursor: default;
    padding-bottom: .5rem;
    display: flex;
    justify-content: center;
...
`,cI=()=>{const[t,e]=ee.useState(!1),n=()=>{e(!t)};return N.jsxs(oI,{children:[t&&N.jsx(ey,{closeModal:n,modalFooterVisible:t}),N.jsxs(aI,{onClick:n,children:[" Full Stack Java Developer ","= ( ) =>","{",N.jsx(lI,{children:"  Mauricio Mores "}),"}"]})]})},uI=ve.div` 
    width: 100vw;
    height: 100vh;
    display: flex;
    justify-content: center;
...
`,fI=()=>N.jsx(uI,{children:N.jsx(dI,{})}),hI=()=>{const[t,e]=ee.useState(!0);return ee.useEffect(()=>{setTimeout(()=>{e(!1)},2e3)},[]),t?N.jsx(fI,{}):N.jsx(Nw,{shouldForwardProp:OM,children:N.jsx(PM,{children:N.jsxs("div",{className:"container_body",children:[N.jsx(tI,{}),N.jsxs(wM,{children:[N.jsx(Er,{path:"/",element:N.jsx(LP,{})}),N.jsx(Er,{path:"About",element:N.jsx(v2,{})}),N.jsx(Er,{path:"Projects",element:N.jsx(M2,{})}),N.jsx(Er,{path:"Technologies",element:N.jsx(D2,{})}),N.jsx(Er,{path:"Contact",element:N.jsx(X2,{})}),N.jsx(Er,{path:"*",element:N.jsx($2,{})})]}),N.jsx(cI,{})]})})})};function pI(){return N.jsx(hI,{})}xd.createRoot(document.getElementById("root")).render(N.jsx(pI,{}));
