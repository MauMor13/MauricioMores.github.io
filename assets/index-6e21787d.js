...
`,b2=ve.img`
    ...
    background-position: center;
    background-size: cover;
`,A2=()=>{const t=["./assets/image/iconTechnologies/swiper-logo.svg","./assets/image/iconTechnologies/css.svg","./assets/image/iconTechnologies/git.svg","./assets/image/iconTechnologies/github.svg","./assets/image/iconTechnologies/html.svg","./assets/image/iconTechnologies/java.svg","./assets/image/iconTechnologies/jira.svg","./assets/image/iconTechnologies/js.svg","./assets/image/iconTechnologies/postgre.svg","./assets/image/iconTechnologies/postman.svg","./assets/image/iconTechnologies/react.svg","./assets/image/iconTechnologies/spring.svg","./assets/image/iconTechnologies/sql.svg","./assets/image/iconTechnologies/styled.svg","./assets/image/iconTechnologies/trello.svg","./assets/image/iconTechnologies/vue.svg","./assets/image/iconTechnologies/bootstrap.svg"];return N.jsx(M2,{children:N.jsx(w2,{children:t.map((e,n)=>{const i=360/t.length*n;return N.jsx(T2,{style:{transform:"rotateY("+i+"deg)  translateZ(25rem)"},children:N.jsx(b2,{src:e},n)},n)})})})},C2=ve.main`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    padding-right: 2rem;
...
`,Kx=()=>N.jsxs(D2,{children:[N.jsxs(gd,{children:[N.jsx(md,{img:"./assets/image/redes/linkedin.svg"}),N.jsx(vd,{href:"https://www.linkedin.com/in/mauricio-mores-b3898817b/",children:"Linkedin: Mauricio Mores"})]}),N.jsxs(gd,{children:[N.jsx(md,{img:"./assets/image/redes/github.svg"}),N.jsx(vd,{href:"https://github.com/MauMor13",children:"Git Hub: Mauricio Mores"})]}),N.jsxs(gd,{children:[N.jsx(md,{img:"./assets/image/redes/gmail.svg"}),N.jsx(vd,{href:"mailto:mauri.f.mores@gmail.com",children:"Gmail: mauri.f.mores@gmail.com"})]})]}),U2=ve.a`
    text-decoration: none;
...
`,Zx=()=>{const[t,e]=ee.useState(!1),n=()=>{e(!0),setTimeout(()=>{e(!1)},3e3)};return N.jsx(U2,{onClick:n,isActive:t,href:"./assets/cv/Mauricio_Mores_Dev_Full_Stack_JAVA.pdf",download:"Mauricio_Mores_Dev_Full_Stack_JAVA",children:"Download CV"})},N2=ve.main`
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    padding-right: 2rem;
